# ロボット・チキンラン！<br>～ロボットの前進・後進を制御して線ギリギリまで進むプログラムを書こう！～
...
>2.ロボットが進むスピードを決めて1秒間で進む距離を測る<br>
>3.ゴールラインまでの距離を1秒間で進む距離で割る<br>
>4.プログラムの止まるまでの時間を3で出た数字×1000にする（秒をミリ秒にする)<br>
>5.ロボットを走らせてみてラインを超えたら止まるまでの時間を減らす<br>
>6.ロボットを走らせてみてラインギリギリより手前で止まったら時間を増やす<br>
