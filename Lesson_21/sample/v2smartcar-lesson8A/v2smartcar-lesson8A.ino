...
//#define IR_BULLET      0xAAA       //code my bullet shoot from IR LED 
 #define IR_BULLET      0xAAA       //test my bullet shoot from IR remoter 
#define LED_PIN 2
#define MY_BULLET       0xBBB       //code my bullet shoot to enemy 
